...
>
  <source src={video} type="video/webm" />
    ...
    <Link to={linkTo} className="text-white text-2xl border-b-2   border-transparent  font-serif hover:border-white animate-pulse transition-all duration-200 ">{linkText}</Link>
    </div>
    </div>
  )
}
