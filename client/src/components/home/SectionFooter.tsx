  ...
  return (
    <footer ref={footerRef} className="w-full bg-black text-white flex flex-col justify-center items-center">
        <div className=" h-60 flex flex-row justify-center items-center gap-160 p-3 border-b border-white">
          ...
          <img src={logo} fetchPriority="high" alt="logo-nordik" className="h-20 w-40 border-r pr-5 object-cover border-white" />
        ...
        <div className=" w-full h-40 flex flex-row justify-between items-center gap-20 p-2 mt-5">
          <div className="w-full h-30 flex ml-60 flex-row justify-center items-center gap-10">
          ...
          <div className="w-full h-full flex flex-row  justify-center items-center gap-10">
            <a  href="#"><img src={logoI} alt="instagram-logo"  className="bg-white rounded-full w-10 object-contain cursor-pointer "/></a>
            <a href="#"><img src={logoF} alt="facebook-logo" className="bg-white rounded-full w-10 object-contain cursor-pointer "/></a>
          </div>
        </div>
    </footer>
  )
